function [H_z_in, H_z_out, dHz_dx_out, dHz_dx_in, dHz_dy_out, dHz_dy_in,...
    E_z_in, E_z_out, dEz_dx_out, dEz_dx_in, dEz_dy_out, dEz_dy_in] = fieldsGyrotropicCrystal2D_eigenwave(x, y, m, a_0, ee, k_0, p, w_0, BD)
